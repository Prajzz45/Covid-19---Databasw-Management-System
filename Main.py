...
con = pymysql.connect(user="root",password='Prajwal31',database='covid')
cur = con.cursor()
...
background_image =Image.open(r"C:\Users\prajw\OneDrive\Desktop\TE Sem 5\DBMS\Covid19 Vaccination System\person.jpg")
